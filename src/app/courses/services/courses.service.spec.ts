...
describe("CoursesService", () => {
  ...
  it('should find a course by id', () => {
    coursesService.findCourseById(12)
      ...
      const req = httpTestingControlller.expectOne('/api/courses/12');
  ...
  it('should five an error if save course fails', () => {
    const changes : Partial<Course> = {titles:{description: 'Testing Course'}};
  ...
  it('should find a list os lessons', () => {
      ...
      const req = httpTestingControlller.expectOne(
